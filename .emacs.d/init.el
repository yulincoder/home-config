...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
    (auto-complete-sage flymake-shell company-shell toml-mode dts-mode cargo flycheck-rust lsp-java flycheck lsp-ui imenu-anywhere pylint monochrome-theme twilight-theme mood-one-theme monotropic-theme monokai-theme magic-latex-buffer humanoid-themes company-erlang racer rust-mode rustic ppd-sr-speedbar function-args color-theme-sanityinc-tomorrow afternoon-theme abyss-theme grip-mode flymd auto-complete-c-headers auto-complete company dired-icon dired-explorer dired-subtree dired-sidebar elpy)))
 '(tool-bar-mode nil)
